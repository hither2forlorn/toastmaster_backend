...
export class InitialMigration1767128241076 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."club_member_role_enum" AS ENUM('MEMBER', 'ADMIN', 'OWNER')`);
        ...
        await queryRunner.query(`ALTER TABLE "agenda_items" ADD CONSTRAINT "FK_da5c1b4b1eb20f7e294f6e3d0d5" FOREIGN KEY ("agenda_template_id") REFERENCES "agenda_templates"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "agenda_templates" ADD CONSTRAINT "FK_027729eca5fb0be8c2211ab9902" FOREIGN KEY ("clubId") REFERENCES "clubs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clubs" ADD CONSTRAINT "FK_b208f1bfca28ae915ab2557e75e" FOREIGN KEY ("owner_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "club_member" ADD CONSTRAINT "FK_bde5bad4e43fbcefa06b9d6a9d9" FOREIGN KEY ("club_id") REFERENCES "clubs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "club_member" ADD CONSTRAINT "FK_439b7482544b3a96f620e5115d4" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "agendas" ADD CONSTRAINT "FK_f6cfec172c2ea645910467aa064" FOREIGN KEY ("meeting_id") REFERENCES "meetings"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "agendas" ADD CONSTRAINT "FK_26db175795d771e051c1d3c6f5a" FOREIGN KEY ("member_id") REFERENCES "club_member"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "agendas" DROP CONSTRAINT "FK_26db175795d771e051c1d3c6f5a"`);
        await queryRunner.query(`ALTER TABLE "agendas" DROP CONSTRAINT "FK_f6cfec172c2ea645910467aa064"`);
        await queryRunner.query(`ALTER TABLE "club_member" DROP CONSTRAINT "FK_439b7482544b3a96f620e5115d4"`);
        await queryRunner.query(`ALTER TABLE "club_member" DROP CONSTRAINT "FK_bde5bad4e43fbcefa06b9d6a9d9"`);
        await queryRunner.query(`ALTER TABLE "clubs" DROP CONSTRAINT "FK_b208f1bfca28ae915ab2557e75e"`);
        await queryRunner.query(`ALTER TABLE "agenda_templates" DROP CONSTRAINT "FK_027729eca5fb0be8c2211ab9902"`);
        await queryRunner.query(`ALTER TABLE "agenda_items" DROP CONSTRAINT "FK_da5c1b4b1eb20f7e294f6e3d0d5"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."agenda_items_system_role_enum"`);
    }
